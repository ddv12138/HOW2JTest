...
//		basicUse();
		removeComments(new File("./src/tk/ddvudo/bufferStream/TestFile"));
	}
	public static void basicUse() throws IOException {
		File f = new File("./src/tk/ddvudo/bufferStream/TestFile");
		File outf = new File("./src/tk/ddvudo/bufferStream/TestFileOutput");
		if (!outf.exists()) {
